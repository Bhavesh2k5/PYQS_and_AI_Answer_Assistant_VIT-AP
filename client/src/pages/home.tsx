...
import { Brain, Upload, Type, Lightbulb, Eye, Download, Copy, Plus, Sparkles } from "lucide-react";
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            Advanced OCR technology meets cutting-edge AI to help you learn better.
          </p>
        </motion.section>
